        ...
        if (selectedPiece) {
            ...
            if (validMoves.some(move => move.row === rowIndex && move.col === colIndex)) {
                ...
                if (Math.abs(rowIndex - selectedPiece.row) === 2 && Math.abs(colIndex - selectedPiece.col) === 2) {
                    ...
                    const turnOwnerResult = turnOwner === "red" ? capturedPiecesCounter["red"] : capturedPiecesCounter["black"];
                    actualizedCapturedPiecesCounterObject = { ...capturedPiecesCounter, [turnOwner]: turnOwnerResult + 1 };
                ...
                if (actualizedCapturedPiecesCounterObject.black === 8 || actualizedCapturedPiecesCounterObject.red === 8) {
        ...
        <>
            ...
            <main className='flex flex-col justify-center items-center mt-2'>
                <section className='text-xl my-6'>
                    ...
                    <div>{(turnOwner!=="none") ? `Turn: ${turnOwner === "red" ? "Red" : "Black"}` : "Partida Terminada"}</div>
                </section>
