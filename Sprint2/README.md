...
|           6. Movimiento de una pieza            |  6.1  |                                                            AC 6.1 <Turno asignado exitoso> Dado un jugador X cuando el jugador Y termina su turno. Entonces el sistema debe habilitar el movimiento del jugador X.                                                             | Pendiente  |              Piero Pilco               |
|                                             |  6.2  |                                                       AC 6.2 <Turno asignado fallido> Dado una ficha dama peon de mi equipo rojo. Y estoy a una casilla atras del borde limite del equipo negro. Cuando hago el movimiento de avance a esa casilla. Entonces mi dama debe convertirse en rey                                                        | Pendiente  | Piero Pilco |
|           7. Coronación de una pieza            |  7.1  |                                                            AC 7.1 <Turno asignado exitoso> Dado una ficha dama peon de mi equipo rojo. Y estoy a una casilla atras del borde limite del equipo negro. Cuando hago el movimiento de avance a esa casilla. Entonces mi dama roja debe convertirse en rey                                                             | Pendiente  |              Piero Pilco               |
|           8. Movimientos de captura            |  8.1  |                                                            AC 8.1 <Turno asignado exitoso> Dado una ficha peon de mi equipo rojo. Y hay una ficha del equipo negro una casilla por delante (diagonalmente). Cuando hago el movimiento de capturar a esa ficha. Entonces se debe desaparecer a esa ficha. Y hacer movimiento de avance para la ficha de mi equipo. Y añadir un punto al contador de capturas de mi equipo.                                                            | Pendiente  |              Piero Pilco               |
|        |  8.2  |                                                            AC 8.2 <Turno asignado exitoso>  Dado una ficha de mi equipo rojo que ya es reina. Y hay una ficha del equipo negro solo una casilla diagonalmente por delante o atrás (tanto izquierda o derecha). Cuando hago el movimiento de capturar a esa ficha. Entonces se debe desaparecer a esa ficha. Y hacer movimiento de avance para la ficha de mi equipo. Y añadir un punto al contador de capturas de mi equipo.                                                      | Pendiente  |              Piero Pilco               |
|           9. Captura de más de una pieza en un turno            |  9.1  |                                                            AC 9.1 <Turno asignado exitoso> Dado una captura realizada de nuestra ficha roja peon. Y el movimiento ya realizado. Cuando se ve que se puede capturar una ficha negra mas. Entonces todavía no se cambia de turno para hacer otra captura. Y seguimos con nuestro turno.                                                            | Pendiente  |              Piero Pilco               |
|        |  9.2  |                                                            AC 9.2 <Turno asignado exitoso>  Dado una captura realizada de nuestra ficha roja peon. Y el movimiento ya realizado. Cuando se ve que se puede capturar una ficha negra mas. Entonces todavía no se cambia de turno para hacer otra captura. Y seguimos con nuestro turno. update                                                      | Pendiente  |              Piero Pilco               |
|           10. Asignación de turno            |  10.1  |                                                            AC 6.1 <Turno asignado exitoso> Dado un jugador X cuando el jugador Y termina su turno. Entonces el sistema debe habilitar el movimiento del jugador X.                                                             | Pendiente  |              Piero Pilco               |
|                                             |  10.2  |                                                       AC 6.2 <Turno asignado fallido> Dado un jugador X cuando el jugador Y aún no termina su turno. Entonces el sistema no debe habilitar el movimiento del jugador X.                                                        | Pendiente  |              Piero Pilco               |
...
|                  7 -                  |   7.1    |        Board            |                           handleSquareOnClickEvent() movePiece()                           |      Piero Pilco         |    Completado      |                                             Para hacer el movimiento a la fila limite para que se convierta en reina.                          |
...
|                  8 -                  |   8.1   |     Board               |                           handleSquareOnClickEvent() movePiece() getSelectedPiece() getValidMovesList()                 |      Piero Pilco         |    Completado      |                                             Para ejecutar el movimiento de captura a la dama opuesta para una dama peon.                         |
...
|                  9 -                  |   9.1   |     Board               |                           handleSquareOnClickEvent() movePiece() getSelectedPiece() getValidMovesList()                 |      Piero Pilco         |    Completado      |                                             Para hacer los movimientos de capturas multiples para una dama peon.                         |
...
|                  10 -                  |       |                    |                           movePiece()                            |      Piero Pilco         |    Completado      |                                             Para ejecutar el movimiento de la dama y hacer que avance                         |
|                  11 -                  |       |                    |                           movePiece()                            |      Piero Pilco         |    Completado      |                                             Para ejecutar el movimiento de la dama y hacer que avance                         |
|                  12 -                  |       |                    |                           movePiece()                            |      Piero Pilco         |    Completado      |                                             Para ejecutar el movimiento de la dama y hacer que avance                         |
